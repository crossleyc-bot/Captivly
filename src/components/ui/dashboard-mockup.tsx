...
export function DashboardMockup() {
  return (
    <div className="relative">
      ...
      <div className="absolute -inset-4 rounded-2xl bg-gradient-to-br from-teal-200/40 via-transparent to-amber-200/30 blur-2xl" />
        ...
        <div className="flex">
          ...
          <div className="flex-1 p-3 sm:p-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                { label: "New Leads", value: "47", trend: "+12%", color: "text-teal-600" },
