      ...
      <div className="flex items-center justify-between rounded-lg border p-4">
        ...
        <button
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            config.is_enabled ? "bg-green-500" : "bg-slate-300"
          }`}
        >
          <span
      ...
      <div className="space-y-2 rounded-lg border p-4">
        ...
        <div className="relative">
          ...
          <button
            type="button"
            onClick={copyEmbed}
            className="absolute right-2 top-2 rounded bg-white px-2 py-1 text-xs font-medium shadow-sm hover:bg-slate-50"
          >
            {copied ? "Copied!" : "Copy"}
          </button>
        </div>
