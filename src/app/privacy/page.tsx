      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-slate-600">
          ...
          <section>
            ...
            <p className="mt-3">
              To exercise any of these rights, contact us at <a href="mailto:privacy@captivly.ai" className="font-medium text-blue-600 hover:text-blue-700">privacy@captivly.ai</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:privacy@captivly.ai" className="font-medium text-blue-600 hover:text-blue-700">privacy@captivly.ai</a>.
            </p>
          </section>
        </div>
      </main>
