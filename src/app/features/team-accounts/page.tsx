        ...
        <section className="bg-gradient-to-b from-indigo-50 via-white to-white px-6 py-20 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg text-zinc-600">
              Let your front desk, sales reps, and managers access leads
              without sharing the owner login. Everyone gets the access they
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="py-3 pr-4 text-zinc-600">1 (owner only)</td>
                    <td className="py-3 pr-4 text-zinc-600">Owner</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 pr-4 font-medium text-zinc-900">
                      Growth
                    </td>
                    <td className="py-3 pr-4 text-zinc-600">Up to 5</td>
        ...
        <section className="border-t bg-zinc-50 px-6 py-20 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-zinc-600">
              No more shared logins. No more &quot;can you check that lead
              for me?&quot; texts. Everyone gets their own account with the
