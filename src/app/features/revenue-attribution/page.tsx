...
export default function RevenueAttributionPage() {
  return (
    <FeatureLayout
      title="Revenue Attribution"
      description="Track the actual dollar value from lead to paying customer. Know exactly how much revenue each campaign, ad, and sequence is generating — not just conversion counts."
      ctaHeading="Know what your leads are worth"
      ctaDescription="Stop guessing which campaigns work. Start tracking real revenue from every lead."
    >
      {/* Why it matters */}
