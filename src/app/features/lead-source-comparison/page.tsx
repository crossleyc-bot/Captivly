...
export default function LeadSourceComparisonPage() {
  return (
    <FeatureLayout
      title="Lead Source Comparison"
      description="Side-by-side performance of Meta vs Google vs organic leads. See which channels deliver the highest-quality leads at the lowest cost — and shift your budget accordingly."
      ctaHeading="Stop guessing. Start comparing."
      ctaDescription="Every dollar you spend on ads should be measured against results. See which channels actually work for your business."
    >
      {/* The problem */}
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            <div className="rounded-lg border p-6 text-center">
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-sm font-semibold text-slate-900">Meta</span>
              </div>
            ...
            <div className="rounded-lg border p-6 text-center">
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-sm font-semibold text-slate-900">Organic</span>
              </div>
              <p className="mt-3 text-sm text-slate-600">
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.metric} className="border-b last:border-0">
                    ...
                    <td className="py-3 pr-4 text-slate-600">{row.meta}</td>
                    <td className="py-3 pr-4 text-slate-600">{row.google}</td>
                    <td className="py-3 pr-4 text-slate-600">{row.organic}</td>
                  </tr>
                ))}
              </tbody>
            </table>
