...
export default function CompliancePage() {
  return (
    <FeatureLayout
      title="TCPA & GDPR Compliance"
      description="Opt-in tracking, consent management, and auto-unsubscribe built into every message. Stay compliant without thinking about it — Captivly.ai handles the legal details so you can focus on leads."
      ctaHeading="Compliant by default"
      ctaDescription="TCPA, GDPR, CAN-SPAM — Captivly.ai handles the legal requirements automatically. Send with confidence, not anxiety."
    >
