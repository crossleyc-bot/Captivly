...
export default function EmailDeliverabilityPage() {
  return (
    <FeatureLayout
      title="Email Deliverability Monitoring"
      description="Track bounce rates, spam complaints, domain reputation, and inbox placement in real time. If your emails aren't landing in the inbox, nothing else matters."
      ctaHeading="Make sure your emails get read"
      ctaDescription="Monitor deliverability, catch problems early, and keep your sender reputation clean — so every outreach email lands in the inbox, not the spam folder."
    >
      {/* The problem */}
