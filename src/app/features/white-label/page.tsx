...
export default function WhiteLabelPage() {
  return (
    <FeatureLayout
      title="White-Label Ready"
      description="On the Pro plan, rebrand Captivly.ai as your own platform. Custom logo, colors, and domain — your clients will never know it's Captivly.ai under the hood."
      ctaHeading="Make it yours"
      ctaDescription="Upgrade to Pro and launch your own branded lead generation platform in minutes."
