...
export default function LeadAssignmentPage() {
  return (
    <FeatureLayout
      title="Lead Assignment Rules"
      description="Automatically route leads to the right team member based on campaign, AI score, location, or round-robin. The right person follows up with the right lead — instantly."
      ctaHeading="Every lead gets an owner"
      ctaDescription="No more leads slipping through the cracks. Auto-assign based on the rules that make sense for your team."
    >
      {/* Why it matters */}
