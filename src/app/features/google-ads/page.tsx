...
export default function GoogleAdsPage() {
  return (
    <FeatureLayout
      title="Google Ads Lead Form Integration"
      description="Capture leads from Google Search and YouTube ads with lead form extensions. Leads flow into Captivly.ai in real time — scored, sequenced, and followed up automatically."
      ctaHeading="Capture leads from every search"
      ctaDescription="Your customers are Googling your service right now. Connect Google Ads and start turning searches into customers."
    >
      {/* Why Google Ads */}
