...
export default function WhatsAppOutreachPage() {
  return (
    <FeatureLayout
      title="WhatsApp Outreach"
      description="Reach leads on the messaging app they use most. WhatsApp boasts 98% open rates — making it the highest-engagement channel for lead follow-up, especially in international markets."
      ctaHeading="Reach leads on their favorite app"
      ctaDescription="98% open rates. 45% response rates. WhatsApp outreach is the highest-engagement channel available — and Captivly.ai makes it automatic."
    >
      {/* Why WhatsApp */}
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.metric} className="border-b last:border-0">
                    ...
                    <td className="py-3 pr-4 text-slate-600">{row.sms}</td>
