      ...
      <main className="flex-1">
        ...
        <section className="border-t bg-zinc-50 px-6 py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-12 overflow-x-auto rounded-lg border bg-zinc-900 p-6">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="py-3 pr-4 text-zinc-600">100</td>
                    <td className="py-3 pr-4 text-zinc-600">1 endpoint</td>
                    <td className="py-3 pr-4 text-zinc-600">1 key</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 pr-4 font-medium text-zinc-900">
                      Growth
                    </td>
                    <td className="py-3 pr-4 text-zinc-600">1,000</td>
                    <td className="py-3 pr-4 text-zinc-600">5 endpoints</td>
                    <td className="py-3 pr-4 text-zinc-600">5 keys</td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-4 font-medium text-zinc-900">
                      Pro
                    </td>
                    <td className="py-3 pr-4 text-zinc-600">10,000</td>
                    <td className="py-3 pr-4 text-zinc-600">Unlimited</td>
                    <td className="py-3 pr-4 text-zinc-600">Unlimited</td>
                  </tr>
                </tbody>
              </table>
