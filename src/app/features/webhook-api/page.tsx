...
export default function WebhookApiPage() {
  return (
    <FeatureLayout
      title="Webhook & API"
      description="Push leads to your own CRM, POS, or custom system in real time. A simple REST API and configurable webhooks for power users who need Captivly.ai data flowing into their existing stack."
      ctaHeading="Connect Captivly.ai to anything"
      ctaDescription="Your CRM, your POS, your custom tools. Webhooks and API give you full control over how Captivly.ai data flows through your business."
    >
      {/* Two approaches */}
