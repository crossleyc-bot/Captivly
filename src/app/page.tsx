...
const CHECK_ICON = (
  <svg className="mt-0.5 h-4 w-4 shrink-0 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-orange-50/30">
        {/* Decorative blobs */}
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:py-28">
          {/* Left — Copy */}
          <div>
            <div className="inline-block rounded-full bg-orange-100 px-4 py-1.5 text-xs font-medium text-orange-700">
              No agency fees. No marketing degree required.
            </div>
            <h1 className="mt-6 text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
              Stop losing leads.{" "}
              <span className="text-blue-600">Start closing them.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/signup"
                className="rounded-full bg-blue-600 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-blue-600/25 transition-all hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30"
              >
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-3 stagger-children">
            ...
            <FadeIn className="relative text-center">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 text-lg font-bold text-white shadow-lg shadow-blue-600/25">
                1
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 stagger-children">
              {[
                ...
                <FadeIn key={feature.title}>
                  <Link
                    href={feature.href}
                    className="block h-full rounded-xl border border-slate-200 bg-white p-5 transition-all hover:border-blue-300 hover:bg-blue-50/50 hover:shadow-md hover:shadow-blue-100/50"
                  >
      ...
      <section className="relative overflow-hidden bg-slate-900 px-6 py-20">
        {/* Decorative gradient */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-blue-900/20 via-transparent to-orange-900/10" />
      ...
      <section id="pricing" className="bg-white px-6 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3 stagger-children">
            ...
            {/* Growth */}
            <FadeIn>
              <div className="relative h-full rounded-xl border-2 border-blue-600 bg-white p-6 shadow-lg shadow-blue-100/50">
                ...
                <Link
                  href="/signup"
                  className="mt-8 block rounded-lg bg-blue-600 px-4 py-2.5 text-center text-sm font-medium text-white transition-colors hover:bg-blue-700"
                >
                  Get Started
                </Link>
              </div>
      ...
      <section className="bg-white px-6 py-20">
        <FadeIn className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 space-y-3">
            <Link
              href="/signup"
              className="inline-block rounded-full bg-blue-600 px-8 py-3.5 text-sm font-medium text-white shadow-lg shadow-blue-600/25 transition-all hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30"
            >
